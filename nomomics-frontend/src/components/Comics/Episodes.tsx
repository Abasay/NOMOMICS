...
const Episodes = (props: { episode: any }) => {
    const { episode } = props;
    return (
        <div className=' flex gap-6 min-w-[400px] max-1280:flex-col items-center'>
            <Image
                src={episodeDummy}
                alt='Dummy Episode'
                width={145}
            ...
            <div className=' flex gap-2 flex-col items-start'>
                <p className=' font-bold  text-xl'>Episode {episode}</p>
                <span className=' text-sm'>July 14, 2024</span>
