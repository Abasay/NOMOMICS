					...
					<div className='relative flex items-center justify-between gap-6 '>
						...
						<div className='flex items-center justify-between'>
							<div>
								...
								<nav
									id='navbarCollapse'
									className={` absolute right-0 z-50 w-[250px] rounded border-[.5px] border-body-color/50 bg-white py-4 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
										navbarOpen
												...
												>
													{menuItem.path ? (
														...
														<div>
															...
															<div
																className={`submenu relative left-0 z-50 top-full rounded-sm bg-white transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[250px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full text-black ${
																	openIndex ===
																	index
																		? 'block'
																		: 'hidden'
