      ...
      <div className='space-y-4'>
        <div>
          <div className='flex justify-between gap-5 items-center mb-1'>
            ...
            <span className=' w-full'>{(cashAmount / 1000).toFixed(0)}k</span>
          </div>
        </div>
        ...
        <div>
          <div className='flex justify-between gap-5 mb-1'>
            ...
            <span className=' w-full'>{(tokenAmount / 1000).toFixed(0)}k</span>
          </div>
        </div>
        ...
        <div className=''>
          <div className='flex justify-between gap-5 mb-1'>
            ...
            <span className=' w-full '>{(coinAmount / 1000).toFixed(0)}k</span>
          </div>
        </div>
      </div>
    </div>
