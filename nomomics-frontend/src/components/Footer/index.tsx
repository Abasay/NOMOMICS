          ...
          <div className=' flex flex-row flex-wrap gap-8 justify-between w-[90%] mx-auto'>
            <div className=' max-w-[250px] px-4 '>
              <div className='mb-6'>
                ...
                {/* <a href="mailto:"></a> */}
                <Link
                  href={'mailto:nomomics@gmail.com'}
                  className='mb-6 pl-3 font-roboto text-base flex items-center gap-3 leading-relaxed text-body-color dark:text-body-color-dark'
                >
                  <span>
                  ...
                  <span>Nomomics.Com</span>
                </Link>
                <Link
                  href={'tel:+2349136624358'}
                  className='mb-6 font-roboto pl-3 flex items-center gap-3 text-base leading-relaxed text-body-color dark:text-body-color-dark'
                >
                  <span>
                    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <path
                  ...
                  <span>+234 913 662 4358</span>
                </Link>
                <Link
                  href={'tel:+2347067351150'}
                  className='mb-6 font-roboto pl-3 flex items-center gap-3 text-base leading-relaxed text-body-color dark:text-body-color-dark'
                >
                  <span>
                    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div className='flex pl-3 items-center'>
                  ...
                  >
                    <svg width='41' height='40' viewBox='0 0 41 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <rect x='0.589844' width='39.59' height='39.59' rx='19.795' fill='#262626' />
                  ...
                  >
                    <svg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <rect x='0.179688' width='39.59' height='39.59' rx='19.795' fill='#262626' />
                      <path
                  ...
                  >
                    <svg width='41' height='40' viewBox='0 0 41 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      <rect x='0.769531' width='39.59' height='39.59' rx='19.795' fill='#CD201F' />
                      <path
            ...
            <div className=' mt-3'>
              <div className='mb-12 lg:mb-16'>
                <h2 className='mb-10 text-3xl   dark:'>Links</h2>
                <ul>
                  <li>
                    <Link
                      href='/'
            ...
            <div className=' mt-3'>
              <div className='mb-12 lg:mb-16'>
                <h2 className='mb-10 text-3xl   dark:'>Legal</h2>
                <ul>
                  <li>
                    <Link
                      href='/'
            ...
            <div className=' mt-3'>
              <div className='mb-12 lg:mb-16'>
                <h2 className='mb-10 text-3xl   dark:'>Product</h2>
                <ul>
                  <li>
                    <Link
                      href='/contact'
            ...
            <div className='mt-3'>
              <div className='mb-8 lg:mb-12 text-center'>
                <h2 className='mb-6 text-2xl lg:text-3xl font-semibold  '>Stay Updated with Comic News!</h2>
