					...
					<div className=' flex flex-row flex-wrap gap-8 justify-between w-[90%] mx-auto'>
						<div className=' max-w-[250px] px-4 '>
							<div className='mb-6'>
								...
								<Link href={'tel:+2349136624358'} className='mb-6 font-roboto pl-3 flex items-center gap-3 text-base leading-relaxed text-body-color dark:text-body-color-dark'>
									<span>
										<svg
											width='24'
											height='24'
								...
								<Link href={'tel:+2347067351150'} className='mb-6 font-roboto pl-3 flex items-center gap-3 text-base leading-relaxed text-body-color dark:text-body-color-dark'>
									<span>
										<svg
											width='24'
											height='24'
